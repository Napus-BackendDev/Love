    ...
    <div className="relative min-h-screen bg-gradient-to-br from-pink-200 to-pink-400 flex items-center justify-center overflow-hidden p-4">
      ...
      <div className="z-10 bg-white p-6 md:p-10 rounded-2xl shadow-xl text-center w-full max-w-md relative">
        ...
        <div className="flex justify-center mb-4">
          <img
            src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWkzeW80bGJvYnIzYW05MjZhaGdsMXFyNDFvbHVyNXFzemphMTRtZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qCT06WLJURMyfsEi2r/giphy.gif"
        ...
        <p className="text-base md:text-lg mb-6">Let your heart decide 🌸</p>
      ...
      <audio ref={audioRef} loop src="/start.mp3" />
